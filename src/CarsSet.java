...
public class CarsSet implements Set<Car> {
    ...
    /**
     * Constructs an empty CarsSet with the initial capacity.
     */
    public CarsSet() {
    ...
    /**
     * Constructs a CarsSet that is a copy of another CarsSet.
     *
     * @param otherSet the CarsSet to copy
     */
    ...
    /**
     * Constructs a CarsSet containing elements of the specified collection.
     *
    ...
    private boolean batchRemove(Collection<?> c, boolean complement) {
        ...
        try {
            ...
            // Очищаємо пам'ять від "зайвих" елементів, які були замінені
